...
#### 分段节点
   ...
   |---------------|---------------------------|
   | 节点名称      | 100 字符以内，工作流内唯一。                               |
   | 分段      |  •分段方式：按单个标志符分段、按多个标志符分段<br>• 分段最大长度：100-2000（默认 800）<br>• 分段重叠：不超过设置的字段分段长度       |
...
#### 节点上下游关系
   ...
   | 节点类型       | 支持上游节点               |支持下游节点                  |
   |---------------|-----------------------|---------------------------|
   | 开始节点       |       无               |<br> •文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点  |
   | 文档解析节点    |      开始节点          |• 信息提取节点<br> • 分段节点<br>• 数据清洗节点<br> • 数据增强节点<br> • 结束节点 |
   | 图片解析节点    |      开始节点          |• 信息提取节点<br> • 分段节点<br>• 数据清洗节点<br> • 数据增强节点<br> • 结束节点  |
   | 音频解析节点    |      开始节点          |• 信息提取节点<br> • 分段节点<br>• 数据清洗节点<br> • 数据增强节点<br> • 结束节点  |
   | 视频解析节点    |      开始节点          |• 信息提取节点<br> • 分段节点<br>• 数据清洗节点<br> • 数据增强节点<br> • 结束节点  |
   | 分段节点       |  • 开始节点<br> • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点<br>   |• 数据清洗节点<br> • 数据增强节点<br> • 结束节点  |
   | 文本嵌入节点    |      • 分段节点        |• 结束节点  |
   | 信息提取节点  | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点        |• 数据增强节点<br> • 结束节点  |
   | 数据清洗节点    | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点 <br> • 分段节点        |• 数据增强节点<br> • 结束节点  |
   | 数据增强节点    | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点<br> • 数据清洗节点<br> • 分段节点<br> • 信息提取节点         |• 结束节点  |
