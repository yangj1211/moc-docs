...
支持多种处理算子，包括：文档解析节点、图片解析节点、音频解析节点、视频解析节点、结构化提取节点、数据清洗节点和数据增强节点。
...
#### 节点上下游关系
   ...
   | 节点类型           | 支持上游节点               |支持下游节点                  |
   |---------------|-----------------------|---------------------------|
   | 开始节点       |       无               |• 结构化提取节点<br> •文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点  |
   | 文档解析节点    |      开始节点          |• 结构化提取节点<br> • 数据清洗节点<br> • 数据增强节点<br> • 结束节点 |
   | 图片解析节点    |      开始节点          |• 结构化提取节点<br> • 数据清洗节点<br> • 数据增强节点<br> • 结束节点  |
   | 音频解析节点    |      开始节点          |• 结构化提取节点<br> • 文档解析节点<br> • 数据增强节点<br> • 结束节点  |
   | 视频解析节点    |      开始节点          |• 结构化提取节点<br> • 文档解析节点<br> • 数据增强节点<br> • 结束节点  |
   | 文本嵌入节点    |      • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点<br> • 数据清洗节点           |• 结束节点  |
   | 结构化提取节点  | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点        |• 数据增强节点<br> • 结束节点  |
   | 数据清洗节点    | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点        |• 数据增强节点<br> • 结束节点  |
   | 数据增强节点    | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点<br> • 数据清洗节点        |• 结束节点  |
   | 结束节点    | • 文档解析节点<br> • 图片解析节点<br> • 音频解析节点<br> • 视频解析节点<br> • 数据清洗节点 <br> • 数据增强节点<br> • 结构化提取节点         |无 |
